 ...
 */
final class Version20230313154153 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, libelle VARCHAR(255) NOT NULL, image MEDIUMTEXT NOT NULL, prix_euro DOUBLE PRECISION NOT NULL, prix_fidelite INT NOT NULL, fidelite TINYINT(1) NOT NULL, description VARCHAR(1000) NOT NULL, reference VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, id_typecommande_id INT DEFAULT NULL, id_utilisateur_id INT DEFAULT NULL, montant_euro DOUBLE PRECISION NOT NULL, montant_fidelite INT NOT NULL, gain_fidelite INT NOT NULL, date_commande DATETIME NOT NULL, INDEX IDX_6EEAA67D15FCCB81 (id_typecommande_id), INDEX IDX_6EEAA67DC6EE5C49 (id_utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
